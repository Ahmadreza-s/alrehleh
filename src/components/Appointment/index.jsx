...
export default function Appointment({ onAppointmentChange }) {
  ...
  const getAvailableTimes = (period) => {
    ...
    const allAfternoonSlots = ['13:00', '14:00', '15:00', '16:00', '17:00', '18:00', '19:00', '20:00'];
  ...
  // وقتی روز تغییر می‌کند، ساعت را ریست کن
  useEffect(() => {
    if (selectedAppointment === 'other') {
          ...
          <Box className={classes.timeSlotsContainer}>
            {(() => {
              ...
              if (availableTimes.length === 0) {
                return (
                  <Typography variant="body2" style={{ textAlign: 'center', color: '#7b7b7b', padding: '16px' }}>
